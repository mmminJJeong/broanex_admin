            ...
            upload: () => {
                return new Promise((resolve, reject) => {
                    ...
                    loader.file.then(file => {
                        ...
                        fetch(`http://211.214.247.21:8000/${UPLOAD_ENDPOINT}/${UPLOAD_ENDPOINT}`, {
                            method: "post",
                            body: body,
                        })
                            .then(res => res.json())
    ...
    return (
        <div className='main-wrapper'>
            ...
            <div className='editor-inside'>
                <input className='input-title' type='text' placeholder='제목을 입력해주세요.' onChange={getValue} name='title' />
                <CKEditor
